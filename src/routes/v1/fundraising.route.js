...
const fundraisingValidation = require('../../validations/fundraising.validation');
...
router
  .route('/:fundraisingId')
  .get(fundraisingController.getFundraising)
...
router.patch(
  ...
  fundraisingController.disableFundraising
);
router.delete(
  '/hard-delete/:fundraisingId',
  auth('manageFundraisings'),
  validate(fundraisingValidation.deleteFundraising),
  fundraisingController.hardDeleteFundraising
);
